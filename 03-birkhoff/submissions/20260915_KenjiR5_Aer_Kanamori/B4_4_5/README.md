...
| ====== |  |
| Modeling Approach | Six-permutation support selection with exact integer-weight reconstruction (sparse order-4 instance) |
...
| ====== |  |
| Total Runtime | 1.014222820 |
| Time to Solution | 1.014222820 |
| CPU Runtime | 1.014222820 |
| GPU Runtime | N/A |
| QPU Runtime | 0 |
| Other HW Runtime | 0 |
| ====== |  |
